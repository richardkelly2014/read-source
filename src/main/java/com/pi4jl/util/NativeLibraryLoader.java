...
public class NativeLibraryLoader {
	...
	public static synchronized void load(String fileName) {
        ...
        //
        String platform = System.getProperty("pi4j.platform", com.pi4jl.platform.Platform.RASPBERRYPI.getId());
        ...
        String linking = System.getProperty("pi4j.linking",
                platform.equalsIgnoreCase(com.pi4jl.platform.Platform.RASPBERRYPI.getId()) ? "dynamic" : "static");
