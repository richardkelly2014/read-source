...
public class DefaultChannelPipeline implements ChannelPipeline {
    ...
    //head channel handler context
    final AbstractChannelHandlerContext head;
    //tail channel handler context
